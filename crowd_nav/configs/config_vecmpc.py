...
class Config(object):
    def __init__(self, model) -> None:
        ...
        self.env.test_size = 100 # number of episodes for test.py
        self.env.randomize_attributes = True # randomize the preferred velocity and radius of humans or not
        self.env.seed = 42  # random seed for environment
        ...
        self.sim.circle_radius = 6 # radius of the circle where all humans start on
        ...
        self.humans.radius = 0.2 # radius of each human
        ...
        self.robot.visible = True  # the robot is visible to humans
